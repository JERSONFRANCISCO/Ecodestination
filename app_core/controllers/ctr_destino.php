<?php 
	...
	require_once("app_core/models/mdl_destino.php"); 
	...
	class ctr_destino {
		...
		if ($_POST['btn_guardarInfo']) {
				...
				if ($_FILES['fotografia']['type'] == "image/jpeg" || $_FILES['fotografia']['type'] == "image/png"|| $_FILES['fotografia']['type'] == "image/jpg" || $_FILES['fotografia']['type'] == "image/gif"  ) {

					if ($_FILES['logo']['type'] == "image/jpeg" || $_FILES['logo']['type'] == "image/png"|| $_FILES['logo']['type'] == "image/jpg"  || $_FILES['logo']['type'] == "image/gif" ) {
