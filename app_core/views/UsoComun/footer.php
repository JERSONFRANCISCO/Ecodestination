        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-heading text-uppercase">Ask a travel expert</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form id="contactForm" name="sentMessage" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase" type="submit">Send Menssaje</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <section id="contact">
        <div id="registro"  class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="mb-4" style=" COLOR: cornsilk;">Traveling to Costa Rica?<BR> Get the Inside Scoop on the Best of Costa Rica</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
